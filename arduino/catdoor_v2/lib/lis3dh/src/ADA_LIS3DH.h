...
/*!
    ...
    Simplified to:
      - avoid the Adafruit_Sensor library
      - skip the float acceleration
*/
/**************************************************************************/
...
class ADA_LIS3DH {
 public:
  ADA_LIS3DH(void);
  ADA_LIS3DH(TwoWire *Wi);
  ADA_LIS3DH(int8_t cspin);
  ADA_LIS3DH(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin);
