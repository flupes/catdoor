// Configure two pin (D5 + D6) on a TCC timer on the Adafruit Feather M0 (SAMD21)
...
void pwm_configure()
{
  ...
  // Enable the port multiplexer for digital pon D5(PA15), D6(PA20) and D11(PA16)
  ...
  // It would be so much easier to reference the actual SAMD21 port/pin directly...
  ...
  REG_TCC0_CC1 = 256;      // Set the duty cycle of the PWM on TCC0 W[2] to 50% (for D10)
  while (TCC0->SYNCBUSY.bit.CC1);
  REG_TCC0_CC2 = 256;      // Set the duty cycle of the PWM on TCC0 W[3] to 50% (for D12)
